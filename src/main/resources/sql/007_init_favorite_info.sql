CREATE TABLE IF NOT EXISTS favorite_info (
    ...
    resource_type VARCHAR(30) NOT NULL DEFAULT 'PRODUCT' COMMENT '资源类型',
    canceled TINYINT NOT NULL DEFAULT 0 COMMENT '是否取消',
    create_time DATETIME NOT NULL COMMENT '创建时间',
    update_time DATETIME NOT NULL COMMENT '更新时间',
    deleted TINYINT NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    UNIQUE KEY uk_favorite_user_resource_type (user_id, resource_type, resource_id),
    KEY idx_favorite_resource_id (resource_id),
    KEY idx_favorite_resource_type (resource_type),
